...
export const FloorPlansPage = () => {
  ...
  const [
    sensorInsertedConfirmationFieldValue,
    setSensorInsertedConfirmationFieldValue,
  ] = React.useState('')
          ...
          <div className={classes.whiteBox}>
            <form className={classes.root} noValidate autoComplete='off'>
              ...
              <FormControlLabel
                control={
                  <GreenCheckbox
                    checked={newSensorTypeState.checkedCO2}
              ...
              <FormControlLabel
                control={
                  <GreenCheckbox
                    checked={newSensorTypeState.checkedMITRUMS}
                    onChange={handleChangeCheck}
                    name='checkedMITRUMS'
                  />
                }
              ...
              <FormControlLabel
                control={
                  <GreenCheckbox
                    checked={newSensorTypeState.checkedTEMP}
                    onChange={handleChangeCheck}
                    name='checkedTEMP'
                  />
                }
